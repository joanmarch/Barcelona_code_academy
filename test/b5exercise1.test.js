...
var calc           = require('../02_javascript/block5/exercise1').calc
...
describe("#test2", function(){
    it ("calc should be 35", function(){
        assert.equal(calc(50,15,'-'),35)
    })
})
...
describe("#test5", function(){
    it ("calc should be wrong data provided", function(){
        assert.equal(calc(500,2), 'wrong data provided')
    })
})
